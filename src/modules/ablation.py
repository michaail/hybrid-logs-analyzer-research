    ...
    *,
    ...
    if histories:
        ...
        for axis, (name, hist) in zip(axes[0], histories.items()):
            ...
            axis.plot(epochs, hist.get("total") or [], "k-", lw=2, label="Total")
            axis.plot(epochs, hist.get("structure") or [], "b--", lw=1.4, label="Structure")
            axis.plot(epochs, hist.get("node") or [], "g-.", lw=1.4, label="Node")
            axis.plot(epochs, hist.get("edge") or [], "r:", lw=1.4, label="Edge")
